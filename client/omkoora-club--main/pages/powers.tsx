...
import {AddPowerModal, UpdatePowerModal,DeletePowerModal  } from "../components/Modal";
...
export default function Powers() {
    ...
    return (
        <Box>
            ...
            <DeletePowerModal title="تعديل صلاحيات" opened={openDeleteModal} id={selectedData} onClose={() => setOpenDeleteModal(false)}/>

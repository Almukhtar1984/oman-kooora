...
import {ActionIcon, Badge, Group, Menu, Pagination, Tooltip,Text,Stack} from '@mantine/core';
import { IconDatabaseOff } from '@tabler/icons-react';
import {DotsVertical, Check, X,InfoCircle,EditCircle} from "tabler-icons-react";
            ...
            selector: (item) => (
                <Group >
                    <Menu shadow="md" width={200} position={"bottom"}>
                        <Menu.Target>
                            <ActionIcon
                                disabled={item?.lastTransfer?.status !== "waiting"}
                                color="gray"
                                variant="light"
                                size="sm"
                            >
                            ...
                            hasPermission("2") ? (
                                <>
                                    <Menu.Item
                                        icon={<X size={14} />}
                                        onClick={() =>
                                            openModelUpdate(item?.lastTransfer, "rejected")
                                        }
                                    >
                                        رفض
                                    </Menu.Item>
                                    <Menu.Item
                                        icon={<Check size={14} />}
                                        onClick={() =>
                                            openModelUpdate(item?.lastTransfer, "accepted")
                                        }
                                    >
                                        قبول
                                    </Menu.Item>

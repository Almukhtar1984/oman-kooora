...
export const TechnicalsTable = ({ list, search, setOpenEditModal, setOpenDeleteModal, setNewStatus, setSelectedRow, setOpenChangeStatusModal, hasPermission, setOpenChangeClassificationModal }: Props) => {

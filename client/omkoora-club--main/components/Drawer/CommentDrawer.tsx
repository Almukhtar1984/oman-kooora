                                        ...
                                        <Stack spacing={5}>
                                            {item?.club
                                                ? <Group align={"flex-start"}>
                                                    <Avatar src={getImageUrl(item?.club?.logo as string)} alt={item?.club?.logo as string} size={38} radius={20}/>
                                                    <Text>{item?.club?.name}</Text>
                                                </Group>
                                                : item?.team
                                                    ? <Group align={"flex-start"}>
                                                        <Avatar src={getImageUrl(item?.team?.logo as string)} alt={item?.team?.logo as string} size={38} radius={20}/>

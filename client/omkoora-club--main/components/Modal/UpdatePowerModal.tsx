...
export const UpdatePowerModal = ({id, opened, ...props}: Props) => {
    ...
    useEffect(() => {
        if (dataClubManagement && "clubManagement" in dataClubManagement && dataClubManagement.clubManagement !== null) {
            ...
            console.log("clubManagement",clubManagement)
            ...
            setTransferPlayers(permission?.transfer_players?.split(","))
            setLoanPlayers(permission?.loan_players?.split(","))
    ...
    const onSubmit = (data: any) => {
        ...
        updateAdminMember({
            ...
            onCompleted: ({updateClubManagement}) => {
                ...
                console.log("idPermissions",idPermissions)
                if(idPermissions===undefined){
                    
                    notyf.open({message: "تمت تعديل البينات ", type:"success", duration: 10000});
                    closeModal();
                    return
                }
                else{
                updatePermission({
                    ...
                    onCompleted: ({createPermission}) => {
                        notyf.open({message: "تمت التعديل بنجاح", type:"success", duration: 10000});
                        closeModal();
                    },

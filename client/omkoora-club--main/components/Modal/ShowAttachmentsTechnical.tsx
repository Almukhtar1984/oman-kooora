...
// Review a technical-staff member's saved attachments (added by their team),
// open any of them, and remove one (with confirm). Deletion refetches the
// technical list so the modal reflects the change on reopen.

...
import {AllClubManagement, AllTechnicals, useMember, useChangeStatusMember, useUpdateMember, useAdminUpdateMember} from "../../graphql";
...
export const UpdateAdminMemberModal = ({id, opened, ...props}: Props) => {
    ...
    const onSubmit = (data: any) => {
        ...
        .then(() => {
            closeModal();
            notyf.success("تم تحديث بيانات العضو بنجاح")
        })
        .catch(reason => {
            console.log(reason)
            notyf.error("حدث خطأ أثناء تحديث بيانات العضو")
        })
    };

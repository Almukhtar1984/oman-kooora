...
const SchedulesTable = ({ data, searchValue, ...props }: Props) => {
    ...
    <Table
      tHead={
        <tr>
          <Th
            // colSpan={2}
            sorted={sortBy === "nameOfDay"}
            reversed={reverseSortDirection}
            onSort={() => setSorting("nameOfDay")}
          >
            اليوم في الاسبوع
          </Th>
          <Th
            sorted={sortBy === "workPeriod"}
            reversed={reverseSortDirection}
            onSort={() => setSorting("workPeriod")}
          >
            فترة المزاولة
          </Th>
          <Th
            sorted={sortBy === "startWork"}
            reversed={reverseSortDirection}
            onSort={() => setSorting("startWork")}
          >
            بداية المزاولة
          </Th>
          <Th
            sorted={sortBy === "endWork"}
            reversed={reverseSortDirection}
            onSort={() => setSorting("endWork")}
          >
            نهاية المزاولة
          </Th>
          <Th

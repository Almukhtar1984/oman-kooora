...
const BranchTable = ({ data, searchValue, onEditModal, ...props }: Props) => {
    ...
    <Table
      tHead={
        <tr>
          <Th
            // colSpan={2}
            sorted={sortBy === "branchName"}
            reversed={reverseSortDirection}
            onSort={() => setSorting("branchName")}
          >
            إسم الفرع
          </Th>
          <Th
            sorted={sortBy === "departments"}
            reversed={reverseSortDirection}
            onSort={() => setSorting("departments")}
          >
            الإدارات
          </Th>
          <Th
            sorted={sortBy === "branchCode"}
            reversed={reverseSortDirection}
            onSort={() => setSorting("branchCode")}
          >
            كود الفرع
          </Th>
          <Th

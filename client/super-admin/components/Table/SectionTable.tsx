...
const SectionTable = ({ data, searchValue, onEditModal, ...props }: Props) => {
    ...
    <Table
      tHead={
        <tr>
          <Th
            // colSpan={2}
            sorted={sortBy === "sectionName"}
            reversed={reverseSortDirection}
            onSort={() => setSorting("sectionName")}
          >
            إسم القسم
          </Th>

          <Th
            sorted={sortBy === "sectionCode"}
            reversed={reverseSortDirection}
            onSort={() => setSorting("sectionCode")}
          >
            كود القسم
          </Th>
          <Th

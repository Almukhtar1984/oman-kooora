...
const mainLinksMockdata = [
  { icon: IconHome2, label: "الرئيسية" },
  { icon: IconBriefcase, label: "الموظفين" },
  { icon: IconFingerprint, label: "الحظور والانصراف" },
  { icon: IconDeviceDesktopAnalytics, label: "مبيعات الموظفين", link: "/sales" },
  { icon: IconBinaryTree2, label: "الفروع", link: "/branches" },
  { icon: IconSettings, label: "الإعدادات" },
];

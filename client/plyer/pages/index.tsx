...
import {AddComplaintModal, UpdateComplaintModal, DeleteComplaintModal} from "../components/Modal";
import {useAllRequests, } from "../graphql";
import useStore from "../store/useStore";
import {ComplaintTable} from "../components/Tables";
...
export default function Home() {
    ...
    return (
        <Box>
            ...
            <AddComplaintModal title="إضافة شكوى" opened={openAddModal} onClose={() => setOpenAddModal(false)} />
            <UpdateComplaintModal title="تعديل الشكوى" opened={openEditModal} data={selectedData} onClose={() => setOpenEditModal(false)} />
            <DeleteComplaintModal opened={openDeleteModal} id={selectedData} onClose={() => setOpenDeleteModal(false)} />
        </Box>
    );
}

...
import {ActionIcon, Avatar, Box, BoxProps, Flex, MantineTheme, Menu, Divider, Text, Tooltip, Badge, Space} from "@mantine/core";
...
const InboxCard = ({ data, onEditModal, onDeleteModal, onChangeStatusModal, setOpenAddAdminModal, setOpenEditAdminModal, ...props }: Props) => {

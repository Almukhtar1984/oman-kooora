...
import {DotsVertical, Id, CalendarStats, Printer} from "tabler-icons-react";
...
export const AssemblyTable = ({ list, search, setOpenEditModal, setOpenDeleteModal, setOpenRenewModal, setNewStatus, setSelectedRow, hasPermission }: Props) => {
    ...
    const COLUMNS = [
        ...
        {name: 'تاريخ الاشتراك', selector: (item: any) => dayjs(item?.subscription_date).format("YYYY-MM-DD"), width: '150px' },

...
import {Check, DotsVertical, EditCircle, FileCertificate, Trash, X} from "tabler-icons-react";
...
export const TechnicalsTable = ({ list, search, setOpenEditModal, setOpenDeleteModal, setSelectedRow, setNewStatus, setOpenChangeStatusModal, hasPermission }: Props) => {

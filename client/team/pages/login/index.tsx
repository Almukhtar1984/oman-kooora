    ...
    let onFormSubmit = ({email, password}: any) => {
        ...
        authenticateClientMutation({
            ...
            onError: (error) => {
                ...
                if (error?.graphQLErrors?.[0]?.extensions?.code == "USER_NOT_EXIST") {
                    setAlert({
                        status: "red",
                ...
                if (error?.graphQLErrors?.[0]?.extensions?.code == "EMAIL_NOT_VERIFY") {
                    setAlert({
                        status: "red",
                ...
                if (error?.graphQLErrors?.[0]?.extensions?.code == "PASSWORD_INCORRECT") {
                    setAlert({
                        status: "red",
                ...
                if (error?.graphQLErrors?.[0]?.extensions?.code == "ACCOUNT_NOT_ACTIVE") {
                    setAlert({
                        status: "red",

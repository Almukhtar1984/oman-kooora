...
export default function TechnicalApparatus() {
    ...
    const [openConvertTechnicalToPlayerModal, setopenConvertTechnicalToPlayerModal] = useState<boolean>(false);
    ...
    return (
        <Box>
            ...
            <AddTechnicalModal title="إضافة عضو" data={selectedData} opened={openAddModal} onClose={() => setOpenAddModal(false)}/>

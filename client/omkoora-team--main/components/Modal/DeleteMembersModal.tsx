...
import {AllMembers, AllTeams, useDeleteMember, useDeleteTeam, useUpdateTeam} from "../../graphql";
...
export const DeleteMembersModal = ({ id, ...props }: Props) => {
    ...
    const onSubmit = () => {
        ...
        .then(() => {
            notyf?.success("تم حذف العضو بنجاح");
            closeModal();
        })
        .catch(reason => {
            console.log(reason)

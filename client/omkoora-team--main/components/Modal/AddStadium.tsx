...
export const AddStadium = (props: Props) => {
    ...
    const {getInputProps, reset, onSubmit, setValues} = useForm({
        ...
        validate: {
            name: (value) => (value?.length > 0 ? null : "اسم الملعب مطلوب"),
            about: (value) => (value?.length > 0 ? null : "نبذه عن الملعب مطلوبة"),
            type: (value) => (value ? null : "نوع العشب مطلوب"),
            rent: (value) => (value?.length > 0 ? null : "قيمة الإيجار مطلوبة"),
            mohafada: (value) => (value ? null : "المحافظة مطلوبة"),
            wiliya: (value) => (value ? null : "الولاية مطلوبة"),
        }
    });
        ...
        createStadium({
            variables: {
                content: {
                    ...
                    images: images,
                    id_team: idTeam,
                    start_time: booking_start,  // Add start_time
                    end_time: booking_end,      // Add end_time
                    mohafada,                   // Add mohafada
                    wiliya                      // Add wiliya
                }
            },

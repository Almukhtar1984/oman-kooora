...
import {AllMembers, useMember, useUpdateMember} from "../../graphql";
...
export const UpdateMembersModal = ({id, opened, ...props}: Props) => {
    ...
    useEffect(() => {
        if (dataMember && "member" in dataMember) {
            form.setValues({
                ...
                membership_date: new Date(dataMember?.member?.membership_date),

                membership_date_end: new Date(dataMember?.member?.membership_date_end),
                ...
                person: {
                    ...
                    date_birth: parseDate(dataMember?.member?.person?.date_birth),

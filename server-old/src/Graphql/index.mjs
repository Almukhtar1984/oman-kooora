...
import {
    ...
    resolversForm,
    resolversPermission,
    resolversStadium, resolversLeague
...
import {
    ...
    typeDefsForm,
    typeDefsPermission,
    typeDefsStadium, typeDefsLeague
...
let schema = makeExecutableSchema({
    typeDefs: [
        ...
        typeDefsForm, typeDefsPermission, typeDefsStadium, typeDefsLeague
    ],
    resolvers: [
        ...
        resolversForm, resolversPermission, resolversStadium, resolversLeague
    ],
});

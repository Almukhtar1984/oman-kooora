...
import {GiAbstract042, GiPlayerNext, GiPlayerPrevious} from "react-icons/gi";
            ...
            >
                ...
                {hasPermission("complaints", "1")
                    ? <Tooltip label={"شكاوى وطلبات واقتراحات اللاعبين"} position={"left"}>
                        ...
                        >
                            <AlertCircle color={theme.colors.cyan[5]} size={24} />
                        </a>
                    </Tooltip>
                    : null
                }
                ...
                {hasPermission("expenses", "1")
                    ?  <Tooltip label={"المصاريف"} position={"left"}>
                        ...
                        >
                            <CurrencyDollar color={theme.colors.cyan[5]} size={24} />
                        </a>
                    </Tooltip>
                    : null
                }
